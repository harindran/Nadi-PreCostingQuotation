...
{
    [FormAttribute("PCNCGE", "Masters/FrmNegotiationCharges.b1f")]
    class FrmNegotiationCharges : UserFormBase
    {
        public static SAPbouiCOM.Form objform;
        public FrmNegotiationCharges(string Code)
        {
            try
            {
                if (Code == "") return;
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                objform = clsModule.objaddon.objapplication.Forms.GetForm("PCNCGE", pVal.FormTypeCount);
