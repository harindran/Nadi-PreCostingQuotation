...
{
    [FormAttribute("PCSPAR", "Masters/FrmSpareMaster.b1f")]
    class FrmSpareMaster : UserFormBase
    {
        public static SAPbouiCOM.Form objform;
        public FrmSpareMaster(string Code)
        {
            try
            {
                if (Code == "") return;
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                objform = clsModule.objaddon.objapplication.Forms.GetForm("PCSPAR", pVal.FormTypeCount);
