...
{
    [FormAttribute("PCBOUT", "Masters/FrmBoughtOut.b1f")]
    class FrmBoughtOut : UserFormBase
    {
        public FrmBoughtOut(string Code)
        {
            try
            {
                if (Code == "") return;
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                objform = clsModule.objaddon.objapplication.Forms.GetForm("PCBOUT", pVal.FormTypeCount);                
