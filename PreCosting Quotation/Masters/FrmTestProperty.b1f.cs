...
{
    [FormAttribute("PCTPROP", "Masters/FrmTestProperty.b1f")]
    class FrmTestProperty : UserFormBase
    {
        public FrmTestProperty(string Code)
        {
            try
            {
                if (Code == "") return;
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                objform = clsModule.objaddon.objapplication.Forms.GetForm("PCTPROP", pVal.FormTypeCount);
