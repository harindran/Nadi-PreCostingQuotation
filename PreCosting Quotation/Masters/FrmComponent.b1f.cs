...
{
    [FormAttribute("PCCOMP", "Masters/FrmComponent.b1f")]
    class FrmComponent : UserFormBase
    {
        public FrmComponent(string Code)
        {
            try
            {
                if (Code == "") return;
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                objform = clsModule.objaddon.objapplication.Forms.GetForm("PCCOMP", pVal.FormTypeCount);
