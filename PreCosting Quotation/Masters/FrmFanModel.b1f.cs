...
{
    [FormAttribute("PCMODEL", "Masters/FrmFanModel.b1f")]
    class FrmFanModel : UserFormBase
    {
        public FrmFanModel(string Code)
        {
            try
            {
                if (Code == "") return;
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.ComboBox0 = ((SAPbouiCOM.ComboBox)(this.GetItem("cmbclass").Specific));
            this.ComboBox1 = ((SAPbouiCOM.ComboBox)(this.GetItem("cmbarr").Specific));
            this.CheckBox0 = ((SAPbouiCOM.CheckBox)(this.GetItem("chkactive").Specific));
            this.StaticText4 = ((SAPbouiCOM.StaticText)(this.GetItem("lrem").Specific));
        ...
        private void Form_LoadAfter(SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                objform = clsModule.objaddon.objapplication.Forms.GetForm("PCMODEL", pVal.FormTypeCount);
        ...
        private void Button0_ClickBefore(object sboObject, SAPbouiCOM.SBOItemEventArg pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                ...
                if (ComboBox0.Selected ==null)
                {
                    ...
                    BubbleEvent = false; ComboBox0.Item.Click();
                    return;
                }
                ...
                if (ComboBox1.Selected == null)
                {
                    ...
                    BubbleEvent = false; ComboBox1.Item.Click();
                    return;
                }
